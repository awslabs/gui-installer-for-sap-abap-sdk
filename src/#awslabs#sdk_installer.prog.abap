...
INTERFACE lif_global_constants.
  CONSTANTS:
    ...
    gc_commit  TYPE string VALUE '6e89e93' ##NO_TEXT,
    gc_date    TYPE string VALUE '2025-11-14 21:13:03 UTC' ##NO_TEXT,
...
INTERFACE lif_sdk_certificate_manager.
  ...
  METHODS:
    ...
    "install_github_root_certs raising lcx_error    " TODO: Implement
